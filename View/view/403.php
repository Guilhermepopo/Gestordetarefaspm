    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                <h1>403</h1>
                <h3 class="text-uppercase">Sem permissão !</h3>
                <p class="text-muted m-t-30 m-b-30">Você não possui acesso para esse conteúdo.</p>
                <a href="/Gestordetarefaspm/app/inicio" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Voltar para home</a> 
            </div>
        </div>
    </section>
</body>
