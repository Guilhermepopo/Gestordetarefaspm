    ...
    <div class="modal-content">
      <div class="modal-header d-block pb-0">
        ...
        <div class="col-12 mb-0">
          <p>Abaixo estão listadas todas as informações da tarefa.</p>
        </div>
        <div id="err"></div>
      </div>
              ...
              <div class="row">
                <div class="col-10">
                  <div class="form-group">
                    ...
                    <input class="titulo form-control" name="titulo" disabled/>
                  </div>
                </div>
               <div class="col-6">
                  <div class="form-group">
                ...
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <textarea class="descricao form-control" name="descricao" rows="3" disabled></textarea>
                  </div>
                </div>
              </div>
            </div>
